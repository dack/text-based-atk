...
class ViewInventory(Action):
    ...
    def __init__(self):
        Action.__init__(self, method=Player.print_inventory, name='View inventory', hotkey='i')


class Attack(Action):
    def __init__(self, enemy):
        Action.__init__(self, method=Player.attack, name="Attack", hotkey='a', enemy=enemy)


class Flee(Action):
    def __init__(self, tile):
        Action.__init__(self, method=Player.flee, name="Flee", hotkey='f', tile=tile)
